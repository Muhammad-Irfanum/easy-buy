...
export default function AdminForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        error.message || "Failed to save admin user. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
            ...
            <div className="sm:col-span-6 border-t border-gray-200 dark:border-gray-700 pt-5">
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  These permissions are automatically set based on the selected
                  role, but you can customize them for this user.
                </p>
