...
import { deleteAdminUser, getAdminUserById } from '@/lib/firebase/admin/adminUserService';
    ...
    return (
      <div className="flex flex-col items-center justify-center h-64 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-md">
          You don&apos;t have permission to view admin user details. This area is restricted to Super Administrators.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Admin User Details</h1>
        </div>
        ...
        <div className="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRoleBadgeClass(adminUser.role)}`}>
                {adminUser.role === 'super-admin' ? 'Super Admin' : 
        ...
        <div className="border-b border-gray-200 dark:border-gray-700">
          <dl>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRoleBadgeClass(adminUser.role)}`}>
                  {adminUser.role === 'super-admin' ? 'Super Administrator' : 
                  adminUser.role === 'admin' ? 'Administrator' : 
                  'Editor'}
                </span>
              </dd>
            ...
            <div className="bg-white dark:bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                {adminUser.createdAt ? new Date(adminUser.createdAt).toLocaleString() : 'Unknown'}
              </dd>
            </div>
          </dl>
        </div>
