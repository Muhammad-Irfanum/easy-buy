...
import { deleteCategory, getCategoryById } from '@/lib/firebase/categories/categoryService';
    ...
    try {
      ...
      toast.error(
        typeof error === 'object' && error !== null && 'message' in error
          ? (error as { message?: string }).message || 'Failed to delete category. Please try again.'
      ...
      <div className="bg-white dark:bg-gray-800 shadow overflow-hidden rounded-lg">
        ...
        <div className="border-b border-gray-200 dark:border-gray-700">
          <dl>
            ...
            <div className={`${category.parentName ? 'bg-gray-50 dark:bg-gray-700/50' : 'bg-white dark:bg-gray-800'} px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6`}>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">
                Products Count
              </dt>
              <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
            ...
            <div className={`${category.parentName ? 'bg-white dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-700/50'} px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6`}>
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">
                Created
              </dt>
              <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
            ...
            <div className={`${category.parentName ? 'bg-gray-50 dark:bg-gray-700/50' : 'bg-white dark:bg-gray-800'} px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6`}>
              ...
              <dd className="mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2">
                {category.updatedAt ? new Date(category.updatedAt).toLocaleString() : 'Unknown'}
              </dd>
            </div>
          </dl>
        </div>
